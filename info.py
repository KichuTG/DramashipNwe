...
CAPTION_LANGUAGES = ["Hindi", "English", "Korean", "Spanish", "French", "German", "Chinese", "Arabic", "Portuguese", "Russian", "Japanese", "Filipino", "Thai"]
...
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/CompletedDramas')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/DramaXship')  # Support group link (make sure bot is admin)
